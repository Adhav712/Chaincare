...
setGlobals() {
  ...
  if [ $USING_ORG -eq 1 ]; then
    ...
    export CORE_PEER_TLS_ROOTCERT_FILE=$PEER0_Ins1starhealth_CA
    ...
    export CORE_PEER_TLS_ROOTCERT_FILE=${PWD}/organizations/peerOrganizations/hosp2vijaya.chaincare.com/peers/peer0.hosp2vijaya.chaincare.com/tls/ca.crt
...
setGlobalsCLI() {
  ...
  if [ $USING_ORG -eq 1 ]; then
    export CORE_PEER_ADDRESS=peer0.Ins1starhealth.chaincare.com:12051
  elif [ $USING_ORG -eq 2 ]; then
